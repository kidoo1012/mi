...
public class BaseDao<T extends BaseModel> implements IBaseDao<T> {
     ...
     */
    @Override
    public List<T> findByMap(String construct, Map<String, Object> map, Page pageBean, String order) {
    ...
    @Override
    public List<T> findByMap(Map<String, Object> map, Page pageBean, String order) {
        String conditions = Tools.getHql(map);
